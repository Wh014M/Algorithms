...
namespace Compression
{
    public static class GZIP
    {
        public static byte[] Compress(byte[] _Bytes)
        {
            ...
            {
                using (GZipStream _GZip_Stream = new GZipStream(_Memory_Stream, CompressionMode.Compress, true))
                {
                    _GZip_Stream.Write(_Bytes, 0x0, _Bytes.Length);
        ...
        public static byte[] Decompress(byte[] _Bytes)
        {
            ...
            {
                using (GZipStream _GZip_Stream = new GZipStream(_Memory_Stream, CompressionMode.Decompress))
                {
                    ...
                    _GZip_Stream.Read(_Decompressed, 0x0, _Size);
